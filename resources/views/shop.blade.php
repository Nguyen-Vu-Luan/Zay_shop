...
<head>
    <title>Laravel Web eCommerce - Shop</title>
    <meta charset="utf-8">
                    ...
                    @foreach ($products as $product)
                        <div class="col-md-4">
                            <div class="card mb-4 product-wap rounded-0">
                                    ...
                                    <div
                                        ...
                                        <ul class="list-unstyled">
                                            <li>
                                                ...
                                                @if($isFavorited)
                                                    {{-- Đã yêu thích → trái tim đậm, bấm để xóa --}}
                                                ...
                                                @else
                                                    {{-- Chưa yêu thích → trái tim trống, bấm để thêm --}}
                                ...
                                <div class="card-body">
                                    <a href="{{ route('shop', $product->id) }}" class="h3 text-decoration-none">
                                        {{ $product->name }}
                                    </a>
                                    <p class="text-center mb-0">{{ number_format($product->price) }}₫</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
                                        ...
                                        <div class="row">
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img"
                                                        src="{{ asset('home/assets/img/brand_01.png') }}"
                                                        alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img"
                                                        src="{{ asset('home/assets/img/brand_02.png') }}"
                                                        alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img"
                                                        src="{{ asset('home/assets/img/brand_03.png') }}"
                                                        alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img"
                                                        src="{{ asset('home/assets/img/brand_04.png') }}"
                                                        alt="Brand Logo"></a>
                                            </div>
                                        </div>
                                    </div>
